## Commit operation of a single Fiber
### Function declaration
```typescript
function commitWork(fiber: Fiber): void;
```
Perform commit operations according to the type of Fiber.effectType
...
```
#### CommitPlace
Replace or create an instance of host Fiber
```typescript
...
```
#### CommitDelete
Delete an instance of host Fiber (removed from the DOM tree)
```typescript
