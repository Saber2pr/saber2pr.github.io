The principle is relatively simple, which is to judge the current language environment through vscode.env.language.
Take a look at how @ iceworks/i18n does it:
```ts
