...
export const Patterns = {
  consolelog: /console[\s\S]*?\.[\s\S]*?log[\s\S]*?\([\s\S]*?\)/g,
  import: /import[\s\S]*?{([\s\S]*?)}[\s\S]*?from[\s\S]*?["']([\s\S]*?)["']/g,
...
/import[\s\S]*?{/     匹配 import + 任意字符串 + {
/import[\s\S]*?{([\s\S]*?)}/     匹配 import + 任意字符串 + { + 任意字符串 + }
/import[\s\S]*?{([\s\S]*?)}[\s\S]*?from/     匹配 import + 任意字符串 + { + 任意字符串 + } + 任意字符串 + from
/import[\s\S]*?{([\s\S]*?)}[\s\S]*?from[\s\S]*?["']/     匹配 import + 任意字符串 + { + 任意字符串 + } + 任意字符串 + from + 任意字符串 + "或'
/import[\s\S]*?{([\s\S]*?)}[\s\S]*?from[\s\S]*?["']([\s\S]*?)["']/     匹配 import + 任意字符串 + { + 任意字符串 + } + 任意字符串 + from + 任意字符串 + "或' + 任意字符串 + "或'
```
